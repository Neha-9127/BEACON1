      ...
      >
        ...
        <div className="px-5 py-3.5 bg-emerald-900 text-white flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 rounded-xl bg-emerald-700/80 text-white flex items-center justify-center">
        ...
        <form onSubmit={handleSubmit} className="p-5 overflow-y-auto space-y-4 text-xs flex-1">
          ...
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3 text-emerald-900 flex items-start space-x-2.5">
            ...
            <div className="leading-relaxed text-[11px]">
              <strong className="font-bold">Required Photo Verification:</strong> To close ticket{' '}
          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <div className="space-y-1">
              ...
              <div className="aspect-video rounded-xl bg-stone-900 overflow-hidden border border-stone-200 relative">
                {report.imageUrl ? (
                  <img
                    src={report.imageUrl}
            ...
            <div className="space-y-1">
              ...
              <div
                ...
                className={`aspect-video rounded-xl overflow-hidden border-2 cursor-pointer relative flex flex-col items-center justify-center transition-colors ${
                  photoUrl
                    ? 'border-emerald-500 bg-stone-900'
                    : 'border-dashed border-stone-300 bg-stone-50 hover:bg-stone-100 text-stone-500'
                }`}
              >
                {photoUrl ? (
                  <>
                  ...
                  <div className="text-center p-2">
                    <Camera className="w-5 h-5 mx-auto text-stone-400 mb-1" />
          ...
          <div className="flex items-center justify-between pt-1">
            <button
              type="button"
              onClick={() => fileInputRef.current?.click()}
              className="px-2.5 py-1.5 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-lg text-[11px] font-medium flex items-center space-x-1"
            >
            ...
            <button
              ...
              className="px-2.5 py-1.5 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 border border-emerald-200 rounded-lg text-[11px] font-semibold flex items-center space-x-1"
            >
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="w-full bg-stone-50 border border-stone-200 rounded-lg p-2 text-stone-900 font-medium focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-600"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full bg-stone-50 border border-stone-200 rounded-lg p-2.5 text-stone-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-600"
            />
          </div>

          {errorMessage && (
            <div className="p-2.5 bg-red-50 text-red-700 border border-red-200 rounded-lg flex items-center space-x-1.5 text-[11px]">
          ...
          <div className="pt-2 flex items-center space-x-2">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 py-2 bg-stone-100 hover:bg-stone-200 text-stone-700 font-semibold rounded-lg transition-colors"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="flex-1 py-2 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-lg shadow-sm transition-colors flex items-center justify-center space-x-1.5"
            >
