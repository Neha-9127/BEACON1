  ...
  return (
    <div className="fixed inset-0 z-[1150] flex items-center justify-center p-3 sm:p-4 bg-black/75 backdrop-blur-xs overflow-y-auto">
      <div
        ...
        className="relative w-full max-w-xl bg-white rounded-2xl shadow-2xl border border-stone-200 overflow-hidden my-auto max-h-[90vh] flex flex-col text-stone-900"
      >
        {/* Header */}
        ...
        <form onSubmit={handleMergeSubmit} className="p-5 overflow-y-auto flex-1 space-y-4 text-xs">
          ...
          <div className="bg-indigo-50/80 border-2 border-indigo-300 rounded-xl p-3.5 space-y-2">
            <div className="flex items-center justify-between text-[11px]">
              <span className="font-bold text-indigo-900 uppercase tracking-wider flex items-center space-x-1.5">
            ...
            <h4 className="font-bold text-stone-900 text-sm">{primaryReport.title}</h4>
            <div className="flex items-center space-x-2 text-stone-600 text-[11px]">
              <MapPin className="w-3.5 h-3.5 text-stone-400" />
              <span>{primaryReport.location.address}</span>
              <span>•</span>
              <span className="font-semibold text-stone-700">{primaryReport.categoryName}</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="max-h-56 overflow-y-auto space-y-2 border border-stone-200 rounded-xl p-2 bg-stone-50/50">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-stone-500 text-[11px] flex items-center space-x-2 mt-0.5">
          ...
          {selectedDuplicateIds.length > 0 && (
            <div className="bg-stone-900 text-white p-3 rounded-xl space-y-1.5 text-xs">
          ...
          {successMessage && (
            <div className="p-3 bg-emerald-50 text-emerald-800 border border-emerald-300 rounded-xl flex items-center space-x-2">
          ...
          <div className="pt-2 flex items-center space-x-2">
            ...
            <button
              ...
              className="flex-1 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white font-bold rounded-lg shadow-sm transition-colors flex items-center justify-center space-x-1.5"
            >
              <GitMerge className="w-4 h-4" />
