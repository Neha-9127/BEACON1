...
export const IncidentDetailModal: React.FC<IncidentDetailModalProps> = ({ report, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1050] flex items-center justify-center p-3 sm:p-4 bg-black/70 backdrop-blur-xs overflow-y-auto">
      <div
        id="incident-detail-modal"
        className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl border border-stone-200 overflow-hidden my-auto max-h-[90vh] flex flex-col"
      >
        {/* Modal Top Header */}
        <div className="px-5 py-3.5 bg-stone-900 text-white flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            {isAi && (
              <span className="text-[10px] font-bold px-2.5 py-1 rounded-full bg-purple-900/80 text-purple-200 border border-purple-400 flex items-center space-x-1 shadow-xs">
            ...
            {/* Top Delete Button on incident detail header - permanent deletion */}
            {showConfirmDeleteTop ? (
              <div className="flex items-center space-x-1.5 bg-red-950/95 border border-red-500/80 px-2 py-0.5 rounded-lg animate-in fade-in">
                <span className="text-[11px] font-bold text-red-200">
                  {isAi ? 'Permanently delete AI post?' : 'Delete ticket?'}
                </span>
                <button
                  type="button"
                  ...
                  className="px-2 py-0.5 bg-red-600 hover:bg-red-700 text-white text-[11px] font-bold rounded shadow-xs active:scale-95"
                >
                ...
                <button
                  ...
                  className="px-1.5 py-0.5 bg-stone-800 hover:bg-stone-700 text-stone-300 text-[11px] rounded"
                >
                  No
                </button>
              </div>
              ...
              <button
                ...
                className={
                  isAi
                    ? "px-2.5 py-1 bg-purple-900/80 hover:bg-red-600 text-purple-200 hover:text-white border border-purple-400/80 hover:border-red-600 font-bold rounded-lg transition-all flex items-center space-x-1 text-xs shadow-xs active:scale-95"
                    : "px-2.5 py-1 bg-red-600/20 hover:bg-red-600 text-red-300 hover:text-white border border-red-500/50 hover:border-red-600 font-bold rounded-lg transition-all flex items-center space-x-1 text-xs shadow-xs active:scale-95"
                }
                title={isAi ? "Permanently delete this AI reported post" : "Permanently delete this incident report from the system"}
              >
        ...
        <div className="p-5 overflow-y-auto flex-1 space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between text-xs font-bold text-stone-500 uppercase tracking-wider mb-1">
              <span>
                {report.categoryName} • {report.subcategory}
              </span>
              <span className="text-emerald-700 font-mono font-bold lowercase">
            ...
            <div className="bg-red-50 border border-red-300/80 rounded-xl p-3 flex flex-col sm:flex-row sm:items-center justify-between gap-2.5">
              ...
              <div className="flex items-center space-x-1.5 flex-shrink-0">
                <button
                  ...
                  className="px-2.5 py-1.5 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-lg transition-colors flex items-center space-x-1 shadow-md active:scale-95 animate-pulse"
                ...
                <button
                  ...
                  className="px-2.5 py-1.5 bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold rounded-lg transition-colors flex items-center space-x-1 shadow-xs active:scale-95"
          ...
          {report.resolutionProof ? (
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs">
                <span className="font-bold uppercase tracking-wider text-stone-700 flex items-center space-x-1.5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {/* Before */}
                <div className="rounded-xl overflow-hidden border border-stone-300 bg-stone-900">
                  <div className="relative aspect-video max-h-48 flex items-center justify-center bg-black">
                    <img
                      src={report.imageUrl}
                    ...
                    />
                    <span className="absolute bottom-2 left-2 bg-black/80 text-white px-2 py-0.5 rounded text-[10px] font-mono">
                ...
                {/* After */}
                <div className="rounded-xl overflow-hidden border-2 border-emerald-500 bg-stone-900">
                  <div className="relative aspect-video max-h-48 flex items-center justify-center bg-black">
                    <img
            ...
            <>
              ...
              {report.videoUrl && (
                <div className="rounded-xl overflow-hidden border-2 border-red-500 bg-stone-950 shadow-md">
                  <div className="p-2.5 bg-red-950/90 text-red-200 text-xs font-bold flex items-center justify-between border-b border-red-800">
                    <span className="flex items-center space-x-1.5">
                      <Film className="w-4 h-4 text-red-400" />
                      <span>Instant Incident Video Footage</span>
                    </span>
                    <span className="font-mono text-[10px] bg-red-900/80 text-white px-2 py-0.5 rounded border border-red-700">
              ...
              {report.imageUrl ? (
                <div className="rounded-xl overflow-hidden border border-stone-300 bg-stone-950 relative group">
                  <div className="relative aspect-video max-h-72 flex items-center justify-center bg-black">
                    <img
                      src={report.imageUrl}
                      alt={report.title}
                      referrerPolicy="no-referrer"
                    ...
                    {isAi && (
                      <div className="absolute top-2.5 left-2.5 bg-purple-950/90 text-purple-200 border border-purple-400 px-2.5 py-1 rounded-lg text-xs font-bold flex items-center space-x-1.5 backdrop-blur-xs shadow-md">
                        <Sparkles className="w-3.5 h-3.5 text-purple-300" />
                        <span>AI Detection Evidence</span>
                      </div>
                    )}

                    {/* Remove Photo Only Button (keeps ticket) */}
                    <div className="absolute top-2.5 right-2.5 z-10">
                      {showConfirmDeleteImage ? (
                        <div className="bg-stone-950/95 backdrop-blur-md p-2 rounded-xl border border-amber-500 shadow-xl flex items-center space-x-2 animate-in fade-in zoom-in-95">
                          <span className="text-[11px] font-bold text-amber-300">Remove Photo?</span>
                          <button
                            type="button"
                            ...
                            className="px-2 py-1 bg-amber-600 hover:bg-amber-700 text-white text-[11px] font-bold rounded-md shadow-xs active:scale-95"
                          >
                            Confirm
                          </button>
                          <button
                            ...
                            className="px-2 py-1 bg-stone-800 hover:bg-stone-700 text-stone-300 text-[11px] font-semibold rounded-md"
                          >
                            Cancel
                          </button>
                        </div>
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 bg-stone-900/80 hover:bg-amber-600 text-stone-200 hover:text-white text-xs font-semibold rounded-lg shadow-lg flex items-center space-x-1.5 transition-colors border border-stone-700 hover:border-amber-500 active:scale-95 backdrop-blur-xs"
                          title="Remove photo only (keeps the incident ticket)"
                        >
                  ...
                  {/* EXIF Metadata Bar */}
                  {report.exifData && (
                    <div className="p-3 bg-stone-900 text-stone-300 text-xs border-t border-stone-800 space-y-1">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[11px] font-mono text-stone-400">
                        <div>
                          <span className="text-stone-500 block">Device:</span>
                        ...
                        <div>
                          <span className="text-stone-500 block">GPS Sync:</span>
                ...
                <div className="rounded-xl border border-dashed border-stone-300 bg-stone-50 p-4 text-center text-xs text-stone-500 flex items-center justify-center space-x-2">
            ...
            <div className="p-3.5 bg-stone-100 rounded-xl border border-stone-200 flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className="w-9 h-9 rounded-full bg-stone-900 hover:bg-black text-white flex items-center justify-center shadow-md transition-colors"
                >
                  {isPlayingAudio ? (
          ...
          <div className="bg-stone-50 border border-stone-200 rounded-xl p-3.5 space-y-2">
            <div className="flex items-center justify-between text-stone-900 text-xs font-bold">
              <div className="flex items-center space-x-2">
          ...
          <div className="p-3 bg-stone-50 border border-stone-200 rounded-xl text-xs space-y-1">
            <div className="font-bold text-stone-800">Privacy & Reporting Party</div>
            {report.isAnonymous ? (
              ...
              <div className="text-stone-700">
                Verified Citizen: <strong>{report.reporterName}</strong>
          ...
          <div className="bg-stone-900 border border-stone-800 rounded-xl p-3.5 text-stone-100 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
              ...
              <div className="p-3 bg-stone-950 rounded-xl border border-stone-800/80 space-y-1.5">
                ...
                <div className="text-[10px] text-stone-400 font-mono pt-1 border-t border-stone-800/60 flex items-center justify-between">
              ...
              <div className="p-3 bg-stone-950 rounded-xl border border-stone-800/80 space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] font-mono font-bold text-blue-300 bg-blue-950 px-1.5 py-0.5 rounded border border-blue-800">
          ...
          {isAuthority ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-xs font-medium bg-white border border-stone-300 rounded-lg p-2 text-stone-900 focus:ring-2 focus:ring-stone-900 focus:outline-none"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs bg-white border border-stone-300 rounded-lg p-2 text-stone-900 focus:ring-2 focus:ring-stone-900 focus:outline-none"
                  />
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full text-xs bg-white border border-stone-300 rounded-lg p-2.5 text-stone-900 focus:ring-2 focus:ring-stone-900 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2 pt-1">
                ...
                {report.domain === 'civic' && !report.resolutionProof && (
                  <button
                    ...
                    className="flex-1 py-2 bg-emerald-50 hover:bg-emerald-100 border border-emerald-300 text-emerald-900 text-xs font-bold rounded-lg transition-colors flex items-center justify-center space-x-1.5"
                  >
                ...
                <button
                  ...
                  className="flex-1 py-2 bg-stone-900 hover:bg-black text-white text-xs font-bold rounded-lg shadow-sm transition-colors flex items-center justify-center space-x-1.5"
                >
            ...
            <div className="p-3.5 bg-stone-50 border border-stone-200 rounded-xl text-xs space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[11px] font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-stone-200 text-stone-800 font-mono">
                  {report.status.replace('_', ' ')}
                </span>
              </div>
              <p className="text-[11px] text-stone-600 leading-relaxed">
                <strong className="text-stone-700">Authority Operational Control:</strong> All changes—including updating workflow status, dispatching crews, adding internal notes, deleting AI images, and deleting reported tickets—can only be done by authorized personnel who are logged in using <strong>Authority Login</strong>.
              </p>
              <div className="pt-1 flex items-center justify-between">
                <span className="text-[11px] text-stone-500 italic">Are you an authorized officer or municipal engineer?</span>
                <button
                  type="button"
                  onClick={() => openLoginModal('authority')}
                  className="px-3 py-1.5 bg-stone-900 hover:bg-black text-white text-xs font-bold rounded-lg transition-colors flex items-center space-x-1.5 shadow-xs"
                >
        ...
        {/* Footer */}
        <div className="px-5 py-3 bg-stone-100 border-t border-stone-200 flex flex-wrap items-center justify-between text-xs gap-2">
          <div className="flex items-center space-x-2">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-semibold flex items-center space-x-2 transition-all border ${
                hasUpvoted
            ...
            >
              ...
              <span
                className={`px-1.5 py-0.2 rounded text-[11px] ${
                  hasUpvoted ? 'bg-blue-700 text-white' : 'bg-stone-200 text-stone-700 font-mono'
                }`}
              >
                {report.upvotesCount}
              </span>
          ...
          <div className="flex items-center space-x-2">
            {showConfirmDeleteModal ? (
              <div className="flex items-center space-x-1.5 bg-red-100 border border-red-300 px-2.5 py-1 rounded-lg animate-in fade-in zoom-in-95">
                <span className="text-xs font-bold text-red-900">
                  {isAi ? 'Permanently delete this AI post? It will never reappear.' : 'Delete ticket permanently?'}
                </span>
                <button
                  type="button"
                  ...
                  className="px-2.5 py-1 bg-red-600 hover:bg-red-700 text-white text-xs font-bold rounded-md shadow-xs active:scale-95"
                >
                ...
                <button
                  ...
                  className="px-2 py-1 bg-stone-200 hover:bg-stone-300 text-stone-700 text-xs font-semibold rounded-md"
                >
                  Cancel
                </button>
              </div>
              ...
              <button
                ...
                className={
                  isAi
                    ? "px-3 py-1.5 bg-purple-100 hover:bg-red-600 text-purple-950 hover:text-white border border-purple-300 hover:border-red-600 font-bold rounded-lg transition-all flex items-center space-x-1.5 active:scale-95 text-xs shadow-xs"
                    : "px-3 py-1.5 bg-red-50 hover:bg-red-600 text-red-700 hover:text-white border border-red-200 hover:border-red-600 font-bold rounded-lg transition-all flex items-center space-x-1.5 active:scale-95 text-xs shadow-xs"
                }
                title={isAi ? "Permanently delete AI reported post" : "Permanently delete incident from database"}
              >
                <Trash2 className="w-3.5 h-3.5 flex-shrink-0" />
                <span>{isAi ? 'Delete AI Post Permanently' : 'Delete Incident'}</span>
              </button>
            )}
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-1.5 bg-stone-200 hover:bg-stone-300 text-stone-800 font-semibold rounded-lg transition-colors text-xs"
            >
              Close
            </button>
          </div>
