...
export const IncidentMap: React.FC<IncidentMapProps> = ({
  ...
  return (
    <div className="relative w-full h-full rounded-2xl overflow-hidden border border-stone-300 shadow-sm">
      <div ref={mapContainerRef} className="w-full h-full min-h-[360px] bg-stone-100" />
      ...
      <div className="absolute top-3 left-3 z-[500] flex flex-col space-y-1.5">
        <button
          ...
          className="p-2 bg-white/95 hover:bg-white text-stone-700 hover:text-stone-900 rounded-xl shadow-md border border-stone-200 backdrop-blur-xs transition-colors"
        ...
        <button
          ...
          className="p-2 bg-white/95 hover:bg-white text-red-600 hover:text-red-700 font-black text-xs rounded-xl shadow-md border border-stone-200 backdrop-blur-xs transition-colors flex items-center justify-center"
          title="Center Chennai Corporation (GCC Hub)"
        >
          <span>CH</span>
        </button>
        <div className="bg-white/95 backdrop-blur-xs rounded-xl shadow-md border border-stone-200 overflow-hidden flex flex-col">
          <button
            type="button"
            onClick={handleZoomIn}
            className="p-2 text-stone-700 hover:text-stone-900 hover:bg-stone-100 transition-colors border-b border-stone-200"
            title="Zoom In"
          >
          ...
          <button
            ...
            className="p-2 text-stone-700 hover:text-stone-900 hover:bg-stone-100 transition-colors"
            title="Zoom Out"
          >
      ...
      <div className="absolute bottom-3 left-3 bg-stone-950/90 backdrop-blur-md text-white px-3 py-1.5 rounded-xl shadow-lg border border-stone-800 text-[11px] font-mono z-[500] flex items-center space-x-2">
        <Radio className="w-3.5 h-3.5 text-red-500 animate-pulse" />
        <span>Chennai GCC Grid • FCM Geo-Fence: <strong>{alertRadiusKm} km</strong> active</span>
      </div>

      {/* Interactive Map Legend Overlay */}
      <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-md px-3 py-2 rounded-xl shadow-md border border-stone-200 text-[11px] text-stone-700 space-y-1.5 z-[500]">
        <div className="font-bold uppercase tracking-wider text-stone-900 border-b border-stone-200 pb-1 flex items-center justify-between">
          <span>Map Pin Logic</span>
          <span className="text-[10px] font-mono text-stone-500">Z{currentZoom}</span>
        </div>
        <div className="flex items-center space-x-2">
          <span className="w-3 h-3 rounded-full bg-red-600 animate-pulse flex-shrink-0" />
        ...
        <div className="flex items-center space-x-2 pt-0.5 border-t border-stone-100 text-[10px] text-stone-500">
          <span className="w-3.5 h-3.5 rounded-full bg-stone-800 text-white flex items-center justify-center font-bold text-[9px]">
            3
          </span>
