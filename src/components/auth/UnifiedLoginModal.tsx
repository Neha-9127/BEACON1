...
export const UnifiedLoginModal: React.FC<UnifiedLoginModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[1200] flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-xs overflow-y-auto">
      <div
        id="unified-login-modal"
        className="w-full max-w-lg bg-white rounded-3xl shadow-2xl border border-stone-200 overflow-hidden text-stone-900 animate-in fade-in zoom-in-95 duration-150 my-auto"
      >
        {/* Header */}
        <div className="bg-stone-900 text-white p-5 sm:p-6 relative">
          ...
          <div className="flex items-center space-x-2 text-[11px] font-mono uppercase tracking-widest text-amber-400 font-bold mb-1">
        ...
        <div className="p-4 sm:p-6 bg-stone-50 border-b border-stone-200">
          <label className="text-[11px] font-bold uppercase tracking-wider text-stone-600 block mb-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className={`p-3.5 rounded-2xl border-2 text-left transition-all relative flex flex-col justify-between ${
                selectedRole === 'citizen'
                  ...
                  : 'border-stone-200 bg-white/70 hover:border-stone-300 text-stone-600'
              }`}
            >
              ...
              <div>
                <div
                  className={`text-sm font-bold ${
                    selectedRole === 'citizen' ? 'text-emerald-950' : 'text-stone-800'
                  }`}
                >
                  Citizen Reporter
                </div>
            ...
            >
              ...
              <div>
                <div
                  className={`text-sm font-bold ${
                    selectedRole === 'authority' ? 'text-stone-900' : 'text-stone-800'
                  }`}
                >
                  Civic Authority
                </div>
        ...
        <div className="p-5 sm:p-6 space-y-4">
          ...
          {currentUser && (
            <div className="p-3 bg-stone-50 rounded-xl border border-stone-200 flex items-center justify-between text-xs">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-stone-600">Current Session:</span>
                <span className="font-bold text-stone-900 truncate max-w-[170px] sm:max-w-[220px]">
          ...
          {/* Feedback messages */}
          {errorMessage && (
            <div className="p-3 bg-red-50 border border-red-200 text-red-800 text-xs rounded-xl flex items-center space-x-2 animate-in fade-in">
          ...
          {selectedRole === 'citizen' && (
            <form onSubmit={(e) => handleCitizenSubmit(e, false)} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full text-xs bg-stone-50 border border-stone-300 rounded-xl pl-9 pr-3 py-2.5 text-stone-900 focus:bg-white focus:ring-2 focus:ring-emerald-600 focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full text-xs bg-stone-50 border border-stone-300 rounded-xl pl-9 pr-10 py-2.5 text-stone-900 focus:bg-white focus:ring-2 focus:ring-emerald-600 focus:outline-none font-mono"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between pt-1 text-xs">
                <span className="text-[11px] text-stone-500">Need demo access?</span>
                <button
                  type="button"
                  id="btn-fill-demo-citizen"
                  onClick={handleLoadCitizenPreset}
                  className="text-[11px] font-bold text-emerald-700 hover:text-emerald-900 flex items-center space-x-1 underline"
                >
              ...
              <div className="space-y-2 pt-2">
                <button
                  ...
                  className="w-full py-3 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl shadow-md transition-all flex items-center justify-center space-x-2 active:scale-95 disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="w-full py-2.5 bg-stone-100 hover:bg-stone-200 text-stone-800 text-xs font-bold rounded-xl border border-stone-200 transition-colors flex items-center justify-center space-x-2"
                >
            ...
            <form onSubmit={handleAuthoritySubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  ...
                  >
                    ...
                    <div className="font-bold text-xs text-stone-900">Chennai Police</div>
                    <div className="text-[10px] text-stone-500">Law & Order / SHO</div>
                  </button>
                  ...
                  >
                    ...
                    <div className="font-bold text-xs text-stone-900">GCC Works</div>
                    <div className="text-[10px] text-stone-500">Municipal Engineer</div>
                  </button>
                  ...
                  >
                    ...
                    <div className="font-bold text-xs text-stone-900">Joint Admin</div>
                    <div className="text-[10px] text-stone-500">ICCC Command</div>
                  </button>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs font-mono font-bold bg-stone-50 border border-stone-300 rounded-xl p-2.5 text-stone-900 focus:bg-white focus:ring-2 focus:ring-stone-900 focus:outline-none"
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full text-xs bg-stone-50 border border-stone-300 rounded-xl p-2.5 text-stone-900 focus:bg-white focus:ring-2 focus:ring-stone-900 focus:outline-none"
                />
              </div>
              ...
              <div className="pt-1">
                ...
                <div className="flex flex-wrap gap-1.5">
                  <button
                    type="button"
                    onClick={() => handleLoadAuthorityPreset('police')}
                    className="text-[11px] bg-stone-100 hover:bg-stone-200 text-stone-800 px-2.5 py-1 rounded-lg font-medium border border-stone-200 transition-colors"
                  >
              ...
              <button
                ...
                disabled={isSubmitting}
                className="w-full py-3 bg-stone-900 hover:bg-black text-white text-xs font-bold rounded-xl shadow-md transition-all flex items-center justify-center space-x-2 active:scale-95 disabled:opacity-50 mt-2"
              >
