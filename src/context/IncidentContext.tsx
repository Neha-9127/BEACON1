...
interface IncidentContextType {
  ...
  // Filters & Sorting
  activeFilterDomain: 'all' | 'civic' | 'safety';
  setActiveFilterDomain: (domain: 'all' | 'civic' | 'safety') => void;
...
export const IncidentProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [activeFilterDomain, setActiveFilterDomain] = useState<'all' | 'civic' | 'safety'>('all');
